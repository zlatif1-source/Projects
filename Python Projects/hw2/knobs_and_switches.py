...
Description:
  to see if the knob and switch open the door.
"""
...
if first_knob < 1 or first_knob > 12:
    ...
    if second_knob < 1 or second_knob > 12:
        ...
        elif (first_knob % 2 == 0 or second_knob % 2 !=0) and switch == "down":
            print("The door clanks but does not open, try again.")
        elif first_knob % 2 == 0 and second_knob % 2 !=0 and switch == "down":
            print("The door clanks but does not open, try again.")
        else:
